...
public class Form_ModificacionProveedor extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Form_ModificacionProveedor() {
		setTitle("Modificacion proveedor");
		...
		JLabel lblModificacionProveedor = new JLabel(
				"Modificaci\u00F3n proveedor");
		lblModificacionProveedor.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblModificacionProveedor.setBounds(195, 0, 220, 34);
		panel.add(lblModificacionProveedor);
		...
		btnAceptar.setBounds(62, 308, 89, 23);
