...
public class Form_ModificarCliente extends JFrame {
	 ...
	 * Create the frame.
	 */
	public Form_ModificarCliente(String identficiacion) {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (ClienteDao.getInstance().update(cliente) == true) {
						JOptionPane.showMessageDialog(null, "Se modificado el registro", 
...
//					ex.mostrarMensaje();
	...
	private void obtenerRegistroModificar(String identificacion){
			...
			for(Cliente cliente : lista){
				if( cliente.getCUITCUIL().equals(identificacion)){
					...
					//txtDueda.setText();
					cmbAfiliacion.setSelectedItem(cliente.getAfiliacionSocial());
			}
		}
	...
	/*
	 *	CONTROLES PARA VALIDAR JTEXTFIELD 
	 * 
	 */
